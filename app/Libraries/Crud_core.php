...
class Crud_core
{
    ...
    function parent_form()
    {
        ...
        $form .= '</div></div><div class="card-footer">
              <button type="submit" class="btn btn-primary btn-sm">' . ($this->action == 'add' ? $this->form_submit : $this->form_submit_update) . '</button>
              </div>' . form_close() . '</div>';
    ...
    protected function field_text($field_type, $label, $field_params)
    {
        ...
        $input = '<input type="text" ' . $required . ' class="form-control form-control-sm" id="' . $field_type . '" name="' . $field_type . '"  placeholder="" value="' . set_value($field_type, (isset($this->current_values->{$field_type}) ? $this->current_values->{$field_type} : '')) . '" autocomplete="off">';
    ...
    {
        $required = (isset($field_params['required']) && $field_params['required'] ? ' required ' : '');
        $input = '<input type="password" ' . $required . ' class="form-control form-control-sm" id="' . $field_type . '" name="' . $field_type . '"   value="" >';
        $password = $this->input_wrapper($field_type, $label, $input, $required);
        $password_confirm = '';
        if (isset($field_params['confirm']) && $field_params['confirm']) {
            $input_confirm = '<input type="password" ' . $required . ' class="form-control form-control-sm" id="' . $field_type . '_confirm" name="' . $field_type . '_confirm"   value="" >';
    ...
    protected function field_number($field_type, $label, $field_params)
    {
        ...
        $input = '<input type="number" ' . $required . ' ' . $attr . ' class="form-control form-control-sm" id="' . $field_type . '" name="' . $field_type . '"  placeholder="" value="' . set_value($field_type, (isset($this->current_values->{$field_type}) ? $this->current_values->{$field_type} : '')) . '" autocomplete="off">';
        return $this->input_wrapper($field_type, $label, $input, $required);
    }
    ...
    {
        $required = (isset($field_params['required']) && $field_params['required'] ? ' required ' : '');
        $input = '<select ' . $required . ' class="form-control form-control-sm" id="' . $field_type . '" name="' . $field_type . '"><option></option>';
    ...
    protected function field_dropdown($field_type, $label, $field_params, $values)
    {
        ...
        $input = '<select  class="form-control form-control-sm" ' . $required . ' id="' . $rid . '" name="' . $field_type . '"><option></option>';
    ...
    protected function field_multiselect($field_type, $label, $field_params, $values)
    {
        ...
        $rand_number = mt_rand(1545645, 15456546);
        $rid = $field_type . '_' . $rand_number;
        $input = '<input type="hidden" name="' . $field_type . '" value=""><select  class="form-control form-control-sm" ' . $required . ' id="' . $rid . '" name="' . $field_type . '[]" multiple="multiple">
                 <option></option>';
    ...
    {
        $required = (isset($field_params['required']) && $field_params['required'] ? ' required ' : '');
        $input = '<input type="email" ' . $required . ' class="form-control form-control-sm" id="' . $field_type . '" name="' . $field_type . '"  placeholder="" value="' . set_value($field_type, (isset($this->current_values->{$field_type}) ? $this->current_values->{$field_type} : '')) . '" autocomplete="off">';
        return $this->input_wrapper($field_type, $label, $input, $required);
    }
    ...
    <script type="text/javascript">
        ...
        //$input = '<input type="datetime-local" '.$required.' class="form-control form-control-sm" id="'.$field_type.'" name="'.$field_type.'"  placeholder="" value="'.set_value($field_type, (isset($this->current_values->{$field_type}) ? $this->current_values->{$field_type} : '')).'" autocomplete="off">';
        return $this->input_wrapper($field_type, $label, $input, $required);
    }
    ...
    {
        $required = (isset($field_params['required']) && $field_params['required'] ? ' required ' : '');
        $input = '<textarea  id="' . $field_type . '"   name="' . $field_type . '"  class="form-control form-control-sm" rows="5" ' . $required . ' placeholder="">' . set_value($field_type, (isset($this->current_values->{$field_type}) ? $this->current_values->{$field_type} : '')) . '</textarea>';
        return $this->input_wrapper($field_type, $label, $input, $required);
    }
    protected function field_editor($field_type, $label, $field_params)
    {
        ...
        $rid = $field_type . '_' . $rand_number;
        $required = (isset($field_params['required']) && $field_params['required'] ? ' required ' : '');
        $input = '<textarea  id="' . $rid . '"   name="' . $field_type . '"  class="form-control form-control-sm" rows="5" ' . $required . ' placeholder="">' . set_value($field_type, (isset($this->current_values->{$field_type}) ? $this->current_values->{$field_type} : '')) . '</textarea>';
        $input .= '
    ...
    protected function items_table($columns = null, $items, $pagination)
    {
            ...
            foreach ($columns as $column) {
                ...
                if (is_array($column)) {
                    ...
                    if ($newCol = $column['search'] ?? false) {
                        ...
                        $label = $column['label'];
                        $table .= '<td><input type="' . $field_type . '" name="' . $newCol . '" class="form-control form-control-sm pull-right" value="' . set_value($newCol) . '" placeholder="' . $label . '"></td>';
                    } else {
                        $table .= '<td></td>';
                        continue;
                    }
                    ...
                    $label = $fields[$column]['label'] ?? ucfirst(str_replace('_', ' ', $column));
                    $table .= '<td><input type="' . $field_type . '" name="' . $column . '" class="form-control form-control-sm pull-right" value="' . set_value($column) . '" placeholder="' . $label . '"></td>';
                }
            }
        } else {
            foreach ($this->schema as $item) {
                ...
                $label = $fields[$item->Field]['label'] ?? ucfirst(str_replace('_', ' ', $item->Field));
                $table .= '<td><input type="' . $field_type . '" name="' . $item->Field . '" class="form-control form-control-sm pull-right" value="' . set_value($item->Field) . '" placeholder="' . $label . '"></td>';
            }
        }

        $table .= '<input type="hidden" name="table_search" class="form-control form-control-sm pull-right" value="' . $this->table . '">';
        ...
        foreach ($items as $item) {
            ...
            $table .= '<td class="text-center"><a href="' . $this->base . '/' . $this->table . '/edit/' . $item->{$primary_key} . '" class="btn btn-success btn-xs">Edit</a></td>';
            $table .= '</tr>';
        }
