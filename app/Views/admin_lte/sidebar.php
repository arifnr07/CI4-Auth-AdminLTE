...
<aside class="main-sidebar sidebar-dark-primary elevation-2 sidebar-collapse">
    <!-- Brand Logo -->
    <a href="<?= base_url() ?>" class="brand-link text-sm ">
        <img src="<?= base_url('admin/assets/img/boxed-bg.png') ?>" alt="AdminLTE Logo" class="brand-image img-circle elevation-3" style="opacity: .8">
